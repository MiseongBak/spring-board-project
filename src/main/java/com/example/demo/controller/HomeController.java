...
public class HomeController {
    ...
    @PostMapping("/signup")
    public String postMemberAdd(@Valid @ModelAttribute("member")
    ...
    public String postPassword(
        ...
        if(!passwordForm.getPassword()
                .equals(passwordForm.getPasswordConfirm())){
            bindingResult.rejectValue(
                    "passwordConfirm", "MissMatch", "비밀번호가 잘못 되었습니다"
            );
        }
        ...
        memberService.updatePassword(
                userDetails.getId(), passwordForm.getPassword()
        );
        return "redirect:/";
    }
}
